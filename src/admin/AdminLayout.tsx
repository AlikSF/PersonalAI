...
import { LayoutDashboard, Package, LogOut, Home, Menu, X, Globe, CalendarDays, Calendar } from 'lucide-react';
...
export function AdminLayout({ children, currentPath }: AdminLayoutProps) {
  ...
  const isActive = (path: string) => {
    ...
    if (path === '/admin/calendar') {
      return currentPath.startsWith('/admin/calendar');
    }
  ...
  const navItems = [
    ...
    { path: '/admin/calendar', label: t.calendar, icon: Calendar },
