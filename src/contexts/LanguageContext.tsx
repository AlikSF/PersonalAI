...
const translations = {
  ...
  // Kazakh translations (using Russian as fallback for now)
  kk: {
    'nav.home': 'Главная',
    'nav.products': 'Товары',
    'nav.contact': 'Контакты',
  ...
  // Kyrgyz translations (using Russian as fallback for now)
  ky: {
    'nav.home': 'Главная',
    'nav.products': 'Товары',
    'nav.contact': 'Контакты',
  ...
  // Azerbaijani translations (using Russian as fallback for now)
  az: {
    'nav.home': 'Главная',
    'nav.products': 'Товары',
    'nav.contact': 'Контакты',
