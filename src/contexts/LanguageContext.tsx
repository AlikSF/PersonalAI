...
const translations = {
  ru: {
    ...
    'products.filter.accommodation': 'Проживание',
    'products.filter.transport': 'Транспорт',
    'products.filter.tours': 'Туры',
    'products.filter.experiences': 'Впечатления',
    'products.filter.food': 'Еда',
    ...
    'booking.guestsPlaceholder': 'Введите количество гостей',
    ...
    'category.tours': 'Туры',
    'category.experiences': 'Впечатления',
    'category.food': 'Еда',
    'category.yacht': 'Яхта',
    'category.car': 'Автомобиль',
    'category.villa': 'Вилла',
    'category.jet': 'Самолёт',
  },
  en: {
    'nav.home': 'Home',
    ...
    'products.filter.accommodation': 'Accommodation',
    'products.filter.transport': 'Transport',
    'products.filter.tours': 'Tours',
    'products.filter.experiences': 'Experiences',
    ...
    'booking.guestsPlaceholder': 'Enter number of guests',
