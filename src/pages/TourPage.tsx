              ...
              {!showBookingForm ? (
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <button
                    ...
                    className="btn-shimmer flex items-center justify-center gap-2 md:gap-3 bg-blue-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-xl text-base md:text-lg font-semibold hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
